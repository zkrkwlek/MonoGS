...
class PlaceRecognizer:
    ...
    def place_recognition(self, desc, keyframes, similarity_threshold = 0.7, similarity_threshold_inter = 0.85, N = 5):
        highestScore = 0
        highestOther = 0
        best_other_idx = None
        best_kf_idx = None
        ...
        top_N = sorted(res, key = lambda x : x, reverse = True)[:N]
